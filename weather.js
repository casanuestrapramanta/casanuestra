...
function generateWeatherHint(code) {
    ...
    if (code >= 95) {
        return "Σήμερα έχει καταιγίδες· απόφυγε ορεινές διαδρομές, κορυφογραμμές και χαράδρες. Προτείνονται κοντινά αξιοθέατα, χωριά και κλειστοί χώροι.";
    }

    // 🌧️ Ισχυρές ή μέτριες βροχές / μπόρες (WMO 80–94)
    if (code >= 80) {
        return "Σήμερα έχει βροχές ή μπόρες· προτίμησε ασφαλείς, εύκολες διαδρομές και απόφυγε μονοπάτια που μπορεί να γλιστρούν ή να έχουν νερά.";
    }

    // ❄️ Χιόνι / Χιονόνερο (WMO 70–79)
    if (code >= 70) {
        return "Σήμερα έχει χιόνι· οι ορεινές διαδρομές μπορεί να είναι δύσβατες. Προτείνονται χαμηλότερα υψόμετρα και ασφαλή μονοπάτια.";
    }
    ...
    if (code >= 1) {
        return "Ο καιρός είναι ήπιος με λίγη συννεφιά· ιδανικός για διαδρομές, μονοπάτια και επισκέψεις σε χωριά με θέα.";
    }
